            ...
            <div className="bg-white rounded-lg m-h-64 p-2 transform hover:translate-y-2 hover:shadow-xl transition duration-300">
              ...
              <div className={`rounded-lg p-4 flex flex-col ${e.gender === "Male" ? "bg-gray-600" : "bg-purple-600"}`} >
                ...
                <div className="flex items-center">
                  ...
                  <button onClick={() => onAdd(e)} href="#" className={`rounded-full text-white hover:bg-white hover:text-purple-900 hover:shadow-xl focus:outline-none w-10 h-10 flex ml-auto transition duration-300 ${e.gender === "male" ? "bg-gray-800" : "bg-purple-900"}`}>
